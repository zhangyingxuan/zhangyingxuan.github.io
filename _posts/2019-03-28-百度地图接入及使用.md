...
description: 本次分享主要记录百度地图v2.0（为了稳定）接入方法，常用地图使用方法，附：经纬度坐标转墨卡托坐标js方法。`本文主要讲解开发过程中的问题收集`
categories:
 - vue
tags:
 - 百度地图
...
# 百度地图接入
1.[注册百度账号](https://passport.baidu.com/v2/?reg&tt=1494238640555&gid=E85D052-3B8B-45D0-9412-D0B861D79A5D&tpl=pp&u=https://passport.baidu.com/)   
2.[申请成为百度开发者](http://lbsyun.baidu.com/apiconsole/key)  
3.[获取密钥（AK）](http://lbsyun.baidu.com/apiconsole/key/create)  
4.[发送请求，使用服务](http://lbsyun.baidu.com/index.php?title=webapi/direction-api-v2)  
...
# 百度地图控制台
[百度地图控制台地址](http://lbsyun.baidu.com/apiconsole/center)
