    ...
    - 普通 http Get 请求
      ...
      **优化前**
      ...
      - [测试 2] request:0.5C512M limit:1C1G
        - 10 并发
          ![0.5C512MB10T.old.jpg](/images/前端性能优化/0.5C512MB10T.old.jpg)
        - 5 并发
          ![0.5C512MB5T.old.jpg](/images/前端性能优化/0.5C512MB5T.old.jpg)
      - [测试 3] request:0.3C256M limit:0.5C512G
        - 10 并发
          ![0.3C256MB10T.old.jpg](/images/前端性能优化/0.3C256MB10T.old.png)
        - 5 并发
          ![0.3C256MB5T.old.jpg](/images/前端性能优化/0.3C256MB5T.old.png)

1.  页面性能测试
    测试工具：Lighthouse

- **优化前**
  ![0.3C256MB5T.old.jpg](/images/前端性能优化/1C1G优化前lighthouse评分.png)
...
![原始包体积](/images/前端性能优化/关闭一些打包配置项.png)

#### 2. webpackChunkName 按路由配置 moudle 合并 chunk

引入包`vite-plugin-webpackchunkname`，使 vite 支持。
...
![优化后包体积](/images/前端性能优化/优化后包体积.png)
...
- request:0.3C256M limit:0.5C512G
  ...
  - 10 并发
    ![0.3C256MB10T.old.jpg](/images/前端性能优化/0.3C256MB10T.new.png)
  - 5 并发
    ![0.3C256MB5T.old.jpg](/images/前端性能优化/0.3C256MB5T.new.jpg)

- lighthouse 结果
  ![0.3C256MB5T.old.jpg](/images/前端性能优化/0.3C256MB优化后lighthouse评分.png)
...
[JMETER 压力测试](https://www.cnblogs.com/stulzq/p/8971531.html)
